...
namespace SalesWebApp.Models
{
    ...
    public partial class MasterVendor
    {
        ...
        public MasterVendor()
        {
            this.MasterVendorContacts = new HashSet<MasterVendorContact>();
        }
        ...
        public int BuyerEmployeeCode { get; set; }
        ...
        public virtual ICollection<MasterVendorContact> MasterVendorContacts { get; set; }
    }
}
